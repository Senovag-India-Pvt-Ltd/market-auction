...
BEGIN
    ...
    BEGIN
        SELECT
            @InTime = 1,
            @AuctionSlot = CASE
                WHEN @CurrentTime BETWEEN AUCTION_1_START_TIME AND AUCTION_2_START_TIME THEN 1
                WHEN @CurrentTime BETWEEN AUCTION_2_START_TIME AND AUCTION_3_START_TIME THEN 2
        ...
        AND (@CurrentTime BETWEEN AUCTION_1_START_TIME AND AUCTION_2_START_TIME
            OR @CurrentTime BETWEEN AUCTION_2_START_TIME AND AUCTION_3_START_TIME
