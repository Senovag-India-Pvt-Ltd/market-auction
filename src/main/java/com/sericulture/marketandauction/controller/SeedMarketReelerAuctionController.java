...
import com.sericulture.marketandauction.service.SeedMarketReelerAuctionService;
...
@RestController
@RequestMapping("/v1/auction/seedMarketAuction")
public class SeedMarketReelerAuctionController {

    @Autowired
    SeedMarketReelerAuctionService seedMarketReelerAuctionService;
    ...
    public ResponseEntity<?> submitBid(@RequestBody ReelerBidRequest reelerBidRequest){
        return seedMarketReelerAuctionService.submitbidSP(reelerBidRequest);
    }
    ...
    public ResponseEntity<?> submitSurrogateBid(@RequestBody ReelerSurrogateBidRequest reelerBidRequest){
        return  seedMarketReelerAuctionService.submitbid(reelerBidRequest);
    }

    @PostMapping("/getHighestBidPerLot")
    public ResponseEntity<?> getHighestBid(@RequestBody LotStatusRequest lotStatusRequest){
        return seedMarketReelerAuctionService.getHighestBidPerLot(lotStatusRequest);
    ...
    public ResponseEntity<?> getHighestBidDetails(@RequestBody LotStatusRequest lotStatusRequest){
        return seedMarketReelerAuctionService.getHighestBidPerLotDetails(lotStatusRequest);
    ...
    public ResponseEntity<?> acceptReelerBidForGivenLot(@RequestBody ReelerBidAcceptRequest reelerBidAcceptRequest){
        return seedMarketReelerAuctionService.acceptReelerBidForGivenLot(reelerBidAcceptRequest);
    ...
    public ResponseEntity<?> rejectReelerBidForGivenLot(@RequestBody ReelerBidAcceptRequest reelerBidAcceptRequest){
        return seedMarketReelerAuctionService.rejectReelerBidForGivenLot(reelerBidAcceptRequest);
    ...
    public ResponseEntity<?> getReelerLotWithHighestBidDetails(@RequestBody ReelerLotRequest reelerLotRequest){
        return seedMarketReelerAuctionService.getReelerLotWithHighestBidDetails(reelerLotRequest);
    }
    ...
    public ResponseEntity<?> removeReelerHighestBid(@RequestBody RemoveReelerHighestBidRequest removeReelerHighestBidRequest){
        return seedMarketReelerAuctionService.removeReelerHighestBid(removeReelerHighestBidRequest);
    }

    @PostMapping("/getReelerBalance")
    public ResponseEntity<?> getReelerBalance(@RequestBody ReelerBalanceRequest reelerBalanceRequest){
        return seedMarketReelerAuctionService.getReelerBalance(reelerBalanceRequest);
    }
